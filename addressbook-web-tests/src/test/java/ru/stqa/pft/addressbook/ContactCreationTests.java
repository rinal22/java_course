...
public class ContactCreationTests {
  ...
  public void testContactCreation() throws Exception {
    ...
    gotoContactPage();
    fillContactForm(new ContactData("Lastname_test", "address_test", "1234567890", "Name_test", "test123@mail.ru"));
  ...
  private void fillContactForm(ContactData contactData) {
    ...
    wd.findElement(By.name("home")).sendKeys(contactData.home_tel());
